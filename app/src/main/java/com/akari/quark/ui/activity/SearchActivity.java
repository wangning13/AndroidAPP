...
import com.akari.quark.ui.adapter.SearchResultsListAdapter;
import com.akari.quark.ui.search.ColorSuggestion;
import com.akari.quark.ui.search.ColorWrapper;
import com.akari.quark.ui.search.DataHelper;
    ...
    private void setupFloatingSearch() {
        mSearchView.setOnQueryChangeListener(new FloatingSearchView.OnQueryChangeListener() {
            ...
            public void onSearchTextChanged(String oldQuery, final String newQuery) {
                ...
                if (!oldQuery.equals("") && newQuery.equals("")) {
                    ...
                    //with a new query.
                    DataHelper.findSuggestions(SearchActivity.this, newQuery, 5, FIND_SUGGESTION_SIMULATED_DELAY, new DataHelper.OnFindSuggestionsListener() {
        ...
        mSearchView.setOnSearchListener(new FloatingSearchView.OnSearchListener() {
            ...
            public void onSuggestionClicked(final SearchSuggestion searchSuggestion) {
                ...
                DataHelper.findColors(SearchActivity.this, colorSuggestion.getBody(),
            ...
            public void onSearchAction(String query) {
                ...
                DataHelper.findColors(SearchActivity.this, query,
                        new DataHelper.OnFindColorsListener() {
